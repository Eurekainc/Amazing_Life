                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('dob') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <!-- <input id="gender" type="date" class="form-control" name="gender" value="{{ old('gender') }}" required autofocus> -->
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control" name="home_address" value="{{ old('address') }}" required autofocus>
